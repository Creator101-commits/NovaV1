...
// Note: This component requires Three.js dependencies to be installed:
...
// Placeholder components for when Three.js is not available
const CanvasRevealEffect = ({
  ...
  // Fallback to a simple animated background when Three.js is not available
  return (
